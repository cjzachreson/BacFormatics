...
% Last Modified by GUIDE v2.5 16-Dec-2015 08:30:38
...
if isempty(Current_Exp)==1
  [filename, pathname, filterindex] = uigetfile({  '*.dat','dat-files (*.dat)';}, 'Please Choose experiment DATA file',Current_Exp)% handles.directory_name); %pick files to combine                  
else   
[filename, pathname, filterindex] = uigetfile({  '*.dat','dat-files (*.dat)';}, 'Please Choose experiment DATA file',Current_Exp)% handles.directory_name); %pick files to combine                  
end
