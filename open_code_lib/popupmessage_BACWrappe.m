...
function popupmessage_BACWrappe(textfile,titlename,command) 
...
if exist('command')~=1 % setup message
 ...
 set(f,'resizefcn','popupmessage_BACWrappe('''','''',''resize_callback'')');
...
set(h,'callback','popupmessage_BACWrappe('''','''',''okaybutton_callback'')');
