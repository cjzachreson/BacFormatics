function b = nlfilter_BACWrapper(varargin)
%NLFILTER General sliding-neighborhood operations. [ without the waitbar)
...
%   $Revision: 5.20.4.17 $  $Date: 2011/08/09 17:51:29 $
